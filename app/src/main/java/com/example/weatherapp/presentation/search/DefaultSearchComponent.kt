...
class DefaultSearchComponent @Inject constructor(
    ...
    private val searchStore: SearchStoreFactory,
    private val onBackClicked: () -> Unit,
    private val onCitySavedToFavourite: () -> Unit,
    private val onForecastForCityRequested: (City) -> Unit,
    componentContext: ComponentContext,
) : ISearchComponent, ComponentContext by componentContext {

    private val store = instanceKeeper.getStore { searchStore.create(openReason) }
